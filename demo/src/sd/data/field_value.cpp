...
kt::field_value_t kt::field_value_t::value_of(double value, field_enum_type_t type) {
...
kt::field_value_t kt::field_value_t::value_of(field_struct_t* value) {
    ...
    std::shared_ptr<field_struct_t> ptr(new field_struct_t(value->get_fields()));
    des_field_value._field_struct = ptr;
    return des_field_value;
}