...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stockmarket_v2: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/stockmarket_v2 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/CurlHelp.o: CurlHelp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CurlHelp.o CurlHelp.cpp
...
${OBJECTDIR}/depthmarketdata.pb.o: depthmarketdata.pb.cc
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/depthmarketdata.pb.o depthmarketdata.pb.cc

${OBJECTDIR}/flow_worker.o: flow_worker.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/flow_worker.o flow_worker.cpp
...
${OBJECTDIR}/md_engine.o: md_engine.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/md_engine.o md_engine.cpp

${OBJECTDIR}/md_pubber.o: md_pubber.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/md_pubber.o md_pubber.cpp

${OBJECTDIR}/public/src/timer/clock.o: public/src/timer/clock.cpp
	${MKDIR} -p ${OBJECTDIR}/public/src/timer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/public/src/timer/clock.o public/src/timer/clock.cpp

${OBJECTDIR}/public/src/timer/epoll.o: public/src/timer/epoll.cpp
	${MKDIR} -p ${OBJECTDIR}/public/src/timer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/public/src/timer/epoll.o public/src/timer/epoll.cpp

${OBJECTDIR}/public/src/timer/poller_base.o: public/src/timer/poller_base.cpp
	${MKDIR} -p ${OBJECTDIR}/public/src/timer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/public/src/timer/poller_base.o public/src/timer/poller_base.cpp

${OBJECTDIR}/public/src/timer/signaler.o: public/src/timer/signaler.cpp
	${MKDIR} -p ${OBJECTDIR}/public/src/timer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/public/src/timer/signaler.o public/src/timer/signaler.cpp

${OBJECTDIR}/public/src/timer/thread.o: public/src/timer/thread.cpp
	${MKDIR} -p ${OBJECTDIR}/public/src/timer
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/public/src/timer/thread.o public/src/timer/thread.cpp

${OBJECTDIR}/sqlconnector.o: sqlconnector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sqlconnector.o sqlconnector.cpp

${OBJECTDIR}/src/file_flow/cache_flow.o: src/file_flow/cache_flow.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/cache_flow.o src/file_flow/cache_flow.cpp

${OBJECTDIR}/src/file_flow/cache_list.o: src/file_flow/cache_list.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/cache_list.o src/file_flow/cache_list.cpp

${OBJECTDIR}/src/file_flow/file_flow.o: src/file_flow/file_flow.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/file_flow.o src/file_flow/file_flow.cpp

${OBJECTDIR}/src/file_flow/flow.o: src/file_flow/flow.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/flow.o src/file_flow/flow.cpp

${OBJECTDIR}/src/file_flow/mpath.o: src/file_flow/mpath.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/mpath.o src/file_flow/mpath.cpp

${OBJECTDIR}/src/file_flow/platform.o: src/file_flow/platform.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/platform.o src/file_flow/platform.cpp

${OBJECTDIR}/src/file_flow/read_only_flow.o: src/file_flow/read_only_flow.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/read_only_flow.o src/file_flow/read_only_flow.cpp

${OBJECTDIR}/src/file_flow/system.o: src/file_flow/system.cpp
	${MKDIR} -p ${OBJECTDIR}/src/file_flow
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/file_flow/system.o src/file_flow/system.cpp
...
${OBJECTDIR}/src/mailbox_event.o: src/mailbox_event.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mailbox_event.o src/mailbox_event.cpp

${OBJECTDIR}/src/mdstock_collector.o: src/mdstock_collector.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mdstock_collector.o src/mdstock_collector.cpp
...
${OBJECTDIR}/src/zmq_poller_reactor.o: src/zmq_poller_reactor.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/zmq_poller_reactor.o src/zmq_poller_reactor.cpp

${OBJECTDIR}/stcode_updator.o: stcode_updator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stcode_updator.o stcode_updator.cpp

${OBJECTDIR}/update_thread.o: update_thread.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/update_thread.o update_thread.cpp
